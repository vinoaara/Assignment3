    ...
    d3.json("json/bar.json",function(err,data){
      data.sort(function(a, b){ return d3.descending(a["urban Population"]+a["Rural Population"], b["urban Population"]+b["Rural Population"]); });
      ...
      var xData=["urban Population","Rural Population"];
